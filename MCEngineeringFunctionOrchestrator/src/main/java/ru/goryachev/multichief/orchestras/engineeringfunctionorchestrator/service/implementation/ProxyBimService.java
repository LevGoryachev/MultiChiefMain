...
public class ProxyBimService extends AbstractProxyService {

    @Autowired
    private ProxyBimService (@Value("${urlscheme.multichief.construction.subdomain.bim}") String subDomain, ConstructionMicroServiceConnector constructionConnector) {
